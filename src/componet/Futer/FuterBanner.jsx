         ...
         <div className="">
            ...
            <div className="relative w-full">
               <img
                  ...
                  src="/businessman-handshake-business-partners-successful-investment-deal-economic-growth-graph 1.png"
                  alt="Background"
               />
            </div>
            ...
            <div className="container mx-auto px-4">
               <div className="flex flex-col lg:flex-row justify-between items-center gap-10 sm:p-6  mt-10 absolute top-20 md:top-12 my-auto">
                  {/* Text Section */}
