      ...
      <>
         <div className="bg-[#F5F9FF]">
            <div className="container mx-auto py-20">
               <h3 className="text-[70px] text-center font-bold">Contact Us</h3>
               <p className="text-[20px] text-center">Support -  <span className="text-[#5965E7] font-bold">Contact us</span></p>
                     ...
                     <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                        <div>
                           ...
                           <ul className="flex mt-12 space-x-4">
                              <li className="bg-red-600 hover:bg-red-600 h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                        ...
                        <div className="bg-gray-100 p-6 rounded-lg">
                           ...
                           <div className="space-y-4 max-lg:mt-6">
                              <button type="button" className="px-4 py-2 rounded-lg bg-red-600 text-white text-sm tracking-wider font-medium outline-none border-2 border-red-600 mr-4">Market</button>
                              <button type="button" className="px-4 py-2 rounded-lg bg-transparent hover:bg-red-600  text-gray-800 text-sm tracking-wider font-medium outline-none border-2 hover:bg-red-600  border-red-600 mr-4">Unick design</button>
                              <button type="button" className="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-red-600">Unick system</button>
                           </div>

                           <form className="mt-8 space-y-4">
                              <input type='text' placeholder='Name'
                                 className="w-full rounded-lg py-3 px-4 text-red-600 text-sm outline-red-600" />
                              <input type='email' placeholder='Email'
                                 className="w-full rounded-lg py-3 px-4 text-red-600 text-sm outline-red-600" />
                              <input type='text' placeholder='Subject'
                                 className="w-full rounded-lg py-3 px-4 text-red-600 text-sm outline-red-600" />
                              <textarea placeholder='Message' rows="6"
                                 className="w-full rounded-lg px-4 text-red-600 text-sm pt-3 outline-red-600"></textarea>
                              <button type='button'
                                 className="shadow-2xl shadow-red-600  text-white bg-red-600 tracking-wide rounded-lg text-sm px-4 py-3 flex items-center justify-center w-full !mt-6">
