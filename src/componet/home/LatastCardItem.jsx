...
function LatastCardItem({ item }) {
   return (
      <>
         <div className="relative bg-white shadow-[#5965E7] hover:shadow-2xl rounded-xl transition-all  duration-300">
            <img className="w-full shadow-[#5965E7]" src={item.img} alt="" />
            ...
            <div className="p-4 ">
               ...
               <div className="text-center mb-7 py-2">
                  <button className="px-5 font-mono p-3 rounded-xl shadow-2xl shadow-[#0554F2]  text-white bg-[#0554F2] ">More Details </button>
               </div>
            </div>
         </div>
